...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <a class="top-nav-btn" id="uptBtn" href="#"><span class="w3-bar-item w3-right">Update User</span></a>
  <a class="top-nav-btn" id="viewBtn" href="#"><span class="w3-bar-item w3-right">View User</span></a>
  <a class="top-nav-btn" id="addBtn" href="#"><span class="w3-bar-item w3-right">Add User</span></a>
</div>
...
<div id="dashboard" class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    ...
    <div class="inner-content">
        <iframe id="innerSrc" frameborder="0" src="add_user.php" width="100%" height="550px"></iframe>
    </div>
...
<script>
    $(document).ready(function(){
        ...
        $('.top-nav-btn').click(function(){
            ...
            switch(val){
                case 'addBtn':
                    $('#innerSrc').attr('src','add_user.php');
                    break;
                case 'delBtn':
